...
department = (("TECHNICAL","technical"), ("FINANCE", "finance"),("ACCOUNTNT","accountant"),("HR","hr"))
role_choice = (("MASTER","master"),("TESTER","tester"),("DEVELOPER","developer"), ("FIELD_WORKER","field_worker"))
...
class OurUser(User):
    ...
    holiday_leaves = models.ForeignKey(holiday_leaves, on_delete=models.CASCADE)
